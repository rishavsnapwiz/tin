...
describe('Load a Page', function () {
    ...
    before(() => {
        ...
        nightMareInstance = nightmare.goto('http://localhost:'+port);
    });
    ...
    it('Register', done => {
        ...
        nightMareInstance = nightmare.goto('http://localhost:'+port+'/register');
        nightMareInstance
            .evaluate(() => {
    ...
    it('EditExpense', done => {
        nightMareInstance = nightmare.goto('http://localhost:'+port+'/expenses');
        nightMareInstance
            .evaluate(() => {
    ...
    it('Expense Report', done => {
        let reports;
        nightMareInstance = nightmare.goto('http://localhost:'+port+'/report_s');
        nightMareInstance
            .wait(400)
            .evaluate(() => {
    ...
    //         .then((formcount) => {
    //             if (formcount == 0) {
    //                 assert.equal(298, 335);
    //                 done();
    //             } else {
    //                 nightMareInstance
    //                     .click(".react-bs-container-body table tbody tr:nth-child(1)")
    //                     .wait(500)
    //                     .click("#approvebtn")
    //                     .wait(500)
    //                     .evaluate(() => {
    //                         return document.querySelector('.react-bs-container-body table tbody tr:nth-child(1) td:nth-child(7) div') && document.querySelector('.react-bs-container-body table tbody tr:nth-child(1) td:nth-child(7) div').innerText;
    //                     })
    //                     .then(function (txt) {
    //                         if(txt=="Approve"){
    //                             assert.equal(1, 1);
    //                             done();
    //                         }else{
    //                             assert.equal(312, 327);
    //                             done();
    //                         }
    //                     })
    //                     .catch(function () {
    //                         assert.equal(312, 326);
    //                         done();
    //                     })
    //             }
    //         })
    //         .catch(function () {
    //             assert.equal(306, 331);
    //             done();
    //         })
    //     })
